...
<input type="checkbox" id="checkbox1" class="styled">如何同时produceliangge两个output方式
...
time <- c(5, 6, 2, 4, 4) 
event <- c(1, 0, 0, 1, 1)
event_data <- data.frame(time = time, event = event)
library(survival)
km <- survfit(Surv(time, event) ~ 1)
library(survminer)
ggsurvplot(km, data = event_data,conf.int = FALSE, risk.table = "nrisk_cumevents", legend = "none")
```
...
报错见[RStudio Community](https://community.rstudio.com/t/questions-for-the-input-of-function-survminer-ggsurvplot/20461)，记得加`data`
